...
//
//	LogicalSort::OrderByAttr
//tmp=LogicalSort::OrderByAttr("LINEITEM.L_ORDERKEY+1",0);
//	vo.push_back(&tmp);
//	LogicalOperator* sort=new LogicalSort(project1,vo);
//
//	//===========================root===========================
//	LogicalOperator* root=new
//LogicalQueryPlanRoot(0,sort,LogicalQueryPlanRoot::PRINT);
//
...
//	//===========================root===========================
//	LogicalOperator* root=new
//LogicalQueryPlanRoot(0,sort1,LogicalQueryPlanRoot::PRINT);
//	root->print();
//	cout<<"performance is ok!"<<endl;
//	getchar();
//	getchar();
