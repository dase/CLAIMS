...
class BlockStreamInIterator : public BlockStreamIteratorBase {
 public:
  ...
  class State {
   ...
   public:
    State(BlockStreamIteratorBase *child_set, BlockStreamIteratorBase *child_in,
    ...
    void serialize(Archive &ar, const unsigned int version) {
      ar &child_set &child_in &schema_child_set &schema_child_in &
          index_child_set &index_child_in &ht_nbuckets &ht_bucketsize &
              block_size_;
    }
