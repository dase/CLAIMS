 ...
 *
 * /CLAIMS/physical_query_plan/physical_sort.h
 *
...
#ifndef PHYSICAL_QUERY_PLAN_PHYSICAL_SORT_H_
#define PHYSICAL_QUERY_PLAN_PHYSICAL_SORT_H_
 ...
 */
class PhysicalSort : public BlockStreamIteratorBase {
 public:
  class State {
   ...
   public:
    ...
    State(Schema* input, vector<unsigned> orderbyKey,
          BlockStreamIteratorBase* child, const unsigned block_size,
...
#endif  // PHYSICAL_QUERY_PLAN_PHYSICAL_SORT_H_
