...
#ifndef PHYSICAL_QUERY_PLAN_EXCHANGE_MERGER_H_
#define PHYSICAL_QUERY_PLAN_EXCHANGE_MERGER_H_
...
class ExchangeMerger : public PhysicalOperator {
 public:
  struct State {
    ...
    State(Schema* schema, BlockStreamIteratorBase* child, unsigned block_size,
...
//}   // namespace physical_query_plan
//}   // namespace claims
#endif  // PHYSICAL_QUERY_PLAN_EXCHANGE_MERGER_H_
