 ...
 *
 * /CLAIMS/physical_query_plan/physical_aggregation.h
 *
...
#ifndef PHYSICAL_QUERY_PLAN_PHYSICAL_AGGREGATION_H_
#define PHYSICAL_QUERY_PLAN_PHYSICAL_AGGREGATION_H_
  ...
  class State {
   ...
   public:
    ...
    State(Schema *input, Schema *output, Schema *hash_schema,
          BlockStreamIteratorBase *child, std::vector<unsigned> groupby_index,
...
#endif  // PHYSICAL_QUERY_PLAN_PHYSICAL_AGGREGATION_H_
