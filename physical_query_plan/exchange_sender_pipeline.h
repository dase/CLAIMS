...
#ifndef PHYSICAL_QUERY_PLAN_EXCHANGE_SENDER_PIPELINE_H_
#define PHYSICAL_QUERY_PLAN_EXCHANGE_SENDER_PIPELINE_H_
...
#endif  // PHYSICAL_QUERY_PLAN_EXCHANGE_SENDER_PIPELINE_H_
