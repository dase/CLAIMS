...
#ifndef PHYSICAL_QUERY_PLAN_EXCHANGE_SENDER_MATERIALIZED_H_
#define PHYSICAL_QUERY_PLAN_EXCHANGE_SENDER_MATERIALIZED_H_
...
#endif  // PHYSICAL_QUERY_PLAN_EXCHANGE_SENDER_MATERIALIZED_H_
