...
//	public:
//		State();
//		State(Schema* input,unsigned orderbyKey,BlockStreamIteratorBase*
//child,const unsigned block_size,const PartitionOffset partitoin_offset=0);
//	public:
//		//TODO: fixed and varible schema both needed!
//		Schema* input_;
//		//TODO:	orderby key can be any one of the column
...
//	void serialize(Archive & ar, const unsigned int version){
//		ar &
//boost::serialization::base_object<BlockStreamIteratorBase>(*this) & state_ ;
//	}
//};
//
//#endif /* BLOCKSTREAMSORTITERATOR_H_ */
