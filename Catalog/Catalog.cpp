...
int Catalog::getTableSize() const { return name_to_table.size(); }
...
//	boost::unordered_map<TableID,TableDescriptor*>::iterator
// it_tableid_to_table;//=tableid_to_table.find(new_table_id);
//	for(it_tableid_to_table = tableid_to_table.begin(); it_tableid_to_table
//!= tableid_to_table.end(); ++it_tableid_to_table)
//	{
