...
int main234ggg(int argc, char** argv){
	int choice=0;
	...
	if(choice==0)
	{
		...
		std::vector<std::string> lower_ip_list_all;
		upper_ip_list.push_back("10.11.1.211");


		lower_ip_list_all.push_back("10.11.1.209");
		lower_ip_list_all.push_back("10.11.1.210");
		lower_ip_list_all.push_back("10.11.1.214");

		lower_ip_list_all.push_back("10.11.1.202");
		lower_ip_list_all.push_back("10.11.1.203");
		lower_ip_list_all.push_back("10.11.1.204");
		lower_ip_list_all.push_back("10.11.1.205");
		lower_ip_list_all.push_back("10.11.1.206");
		lower_ip_list_all.push_back("10.11.1.207");
		lower_ip_list_all.push_back("10.11.1.208");
		lower_ip_list_all.push_back("10.11.1.201");


		for(unsigned i=0;i<lowers;i++){
			lower_ip_list.push_back(lower_ip_list_all[i]);
		}

		std::cout<<" lowers="<<lower_ip_list.size()<<std::endl;
