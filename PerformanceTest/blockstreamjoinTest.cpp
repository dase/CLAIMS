...
//		BlockStreamIteratorBase* ebssc=new ExpandableBlockStreamSingleColumnScan(ebssc_state);
		...
		ExpandableBlockStreamSingleColumnScan::State ebssc_state1("/home/imdb/temp/zhanglei/Uniform_0_99.column_10000",schema,block_size);
		...
		ExpandableBlockStreamSingleColumnScan::State ebssc_state3("/home/imdb/temp/zhanglei/Uniform_0_99.column_10000_copy",schema,block_size);
...
//		BlockStreamIteratorBase* bbsf=new ExpandableBlockStreamFilter(ebsf_state);
		...
		ExpandableBlockStreamBroadcastExchange::State ebse_state(output,bse,block_size,used_lowers,upper_ip_list,exchange_id);
		...
		BlockStreamPerformanceMonitorTop::State bspfm_state(output_join,bse_,block_size,1000);
