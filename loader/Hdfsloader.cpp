...
#include "../common/file/FileHandleImp.h"
...
Hdfsloader::Hdfsloader(const char c_separator, const char r_separator,
                       ...
                       TableDescriptor* tableDescriptor, FileOpenFlag open_flag)
    : table_descriptor_(tableDescriptor),
      col_separator(c_separator),
      row_separator(r_separator),
      file_list(file_name),
...
Hdfsloader::~Hdfsloader() {
  ...
  writepath.clear();
  file_list.clear();
  delete table_descriptor_;
  table_descriptor_ = NULL;
  delete connector_;
  connector_ = NULL;
}
