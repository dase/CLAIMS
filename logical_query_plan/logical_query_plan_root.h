 ...
 *
 * /Claims/logical_query_plan/logical_query_plan_root.h
 *
...
#ifndef LOGICAL_QUERY_PLAN_LOGICAL_QUERY_PLAN_ROOT_H_
#define LOGICAL_QUERY_PLAN_LOGICAL_QUERY_PLAN_ROOT_H_
#include <string>
#include <vector>
...
class LogicalQueryPlanRoot : public LogicalOperator {
 public:
   ...
   * @param collecter_node_id : specify the id of node that return result to client, which is called master
  ...
  /**
   * @brief Method description: generate a few physical operators according to this logical operator
   * @param block_size : give the size of block in physical plan
   * @return the total physical plan include the physical plan generated by child operator
   */
  ...
  /**
   * @brief Method description: print the limit info and call child to print their logical operator info
   * @param level : specify the level of this operator, the top level is 0. so this class's level is always 0.
...
#endif  // LOGICAL_QUERY_PLAN_LOGICAL_QUERY_PLAN_ROOT_H_
