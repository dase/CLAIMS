...
#ifndef EXPR_TYPE_CAST_H_
#define EXPR_TYPE_CAST_H_
#include <sstream>
#include <stdlib.h>
#include "data_type.h"
#include <string.h>
...
inline void *string_to_decimal(void *value, void * tovalue) {
    *(NValue *) tovalue = NValue::getDecimalValueFromString(
            string((char *) value));
    return tovalue;
}
...
inline void *decimal_to_boolean(void *value, void * tovalue) {
    ...
    *(bool *) tovalue = tvalue.op_equals(
            NValue::getDecimalValueFromString("0"));
    return tovalue;
}
/***************decimal****************************/
...
inline void *time_to_string(void *value, void *tovalue) {
    strcpy((char *) tovalue,
           to_simple_string(*(time_duration *) value).c_str());
    return tovalue;
}
/***************time****************************/
...
//t_smallInt
    ExprTypeCast::type_cast_func_[t_smallInt][t_smallInt] =
            smallInt_to_smallInt;
    ...
    ExprTypeCast::type_cast_func_[t_string][t_date_month] =
            string_to_date_month;
    ...
    ExprTypeCast::type_cast_func_[t_datetime][t_datetime] =
