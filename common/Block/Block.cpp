...
int allocate = 0;
Block::Block(unsigned BlockSize) : BlockSize(BlockSize), isReference_(false) {
...
void* Block::getBlock() const { return start; }
unsigned Block::getsize() const { return BlockSize; }
unsigned Block::setsize(const unsigned& size) { BlockSize = size; }
void Block::setBlock(void* addr) { start = (char*)addr; }
