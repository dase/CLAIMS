...
// enum data_type{t_smallInt,t_int,t_u_long,t_float,t_double,t_string, t_date,
// t_time, t_datetime, t_decimal};
...
static void initialize_arithmetic_type_promotion_matrix() {
   ...
   */
  memset(TypePromotion::arith_type_promotion_map, DATA_TYPE_NUMBER,
